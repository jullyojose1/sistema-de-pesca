...
--
-- Estrutura da tabela `arqpescado`
--

CREATE TABLE `arqpescado` (
  `codPescArq` int(11) NOT NULL,
  `codPescado` int(11) NOT NULL,
...
--
-- Estrutura da tabela `pescado`
--

CREATE TABLE `pescado` (
  `codPescado` int(11) NOT NULL,
  `nomePescado` varchar(255) NOT NULL,
  `massaPescado` varchar(40) NOT NULL,
  `tamPescado` varchar(40) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- --------------------------------------------------------

--
-- Estrutura da tabela `pescaria`
--

CREATE TABLE `pescaria` (
  `codPescaria` int(11) NOT NULL,
  `dtPescaria` date NOT NULL,
  `hrPescaria` time NOT NULL,
  `codEndPesc` int(11) NOT NULL,
  `amigo` int(11) NOT NULL,
  `codUser` int(11) NOT NULL,
  `qtdPescado` int(11) NOT NULL,
  `codPescado` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estrutura da tabela `pescendereco`
--

CREATE TABLE `pescendereco` (
  `codPescEnd` int(11) NOT NULL,
  `codPescaria` int(11) NOT NULL,
...
--
-- Estrutura da tabela `usercontato`
--

CREATE TABLE `usercontato` (
  `codUserCont` int(11) NOT NULL,
  `codUser` int(11) NOT NULL,
  `telFixo` varchar(30) NOT NULL,
...
--
-- Estrutura da tabela `userendereco`
--

CREATE TABLE `userendereco` (
  `codUserEnd` int(11) NOT NULL,
  `codUser` int(11) NOT NULL,
  `rua` varchar(255) NOT NULL,
  `bairro` varchar(255) NOT NULL,
  `estado` int(11) NOT NULL,
...
--
-- Índices para tabela `arqpescado`
--
ALTER TABLE `arqpescado`
  ADD PRIMARY KEY (`codPescArq`);
...
--
-- Índices para tabela `pescado`
--
ALTER TABLE `pescado`
  ADD PRIMARY KEY (`codPescado`);

--
-- Índices para tabela `pescaria`
--
ALTER TABLE `pescaria`
  ADD PRIMARY KEY (`codPescaria`),
  ADD KEY `codPescado` (`codPescado`),
  ADD KEY `codUser` (`codUser`),
  ADD KEY `amigo` (`amigo`);

--
-- Índices para tabela `pescendereco`
--
ALTER TABLE `pescendereco`
  ADD PRIMARY KEY (`codPescEnd`),
  ADD KEY `codPescaria` (`codPescaria`);

--
-- Índices para tabela `usercontato`
--
ALTER TABLE `usercontato`
  ADD PRIMARY KEY (`codUserCont`),
  ADD KEY `codUser` (`codUser`);

--
-- Índices para tabela `userendereco`
--
ALTER TABLE `userendereco`
  ADD PRIMARY KEY (`codUserEnd`);
...
--
-- AUTO_INCREMENT de tabela `arqpescado`
--
ALTER TABLE `arqpescado`
  MODIFY `codPescArq` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de tabela `pescado`
--
ALTER TABLE `pescado`
  MODIFY `codPescado` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `pescaria`
--
ALTER TABLE `pescaria`
  MODIFY `codPescaria` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `pescendereco`
--
ALTER TABLE `pescendereco`
  MODIFY `codPescEnd` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `usercontato`
--
ALTER TABLE `usercontato`
  MODIFY `codUserCont` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `userendereco`
--
ALTER TABLE `userendereco`
  MODIFY `codUserEnd` int(11) NOT NULL AUTO_INCREMENT;
