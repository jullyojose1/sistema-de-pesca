<?php
    ...
    if(isset($_FILES['ftPescado'])){
        ...
        $sql = "INSERT INTO pescado (nomePescado, massaPescado, tamPescado) VALUES ('$nomePescado','$massaPescado','$tamPescado')";

        if($query = mysqli_query($link, $sql)){
            $codPescado = mysqli_insert_id($link);
            move_uploaded_file($_FILES['ftPescado']['tmp_name'],$diretorio.$novo_nome);

            $sqlFoto = "INSERT INTO arqpescado (codPescado, arquivo, data) VALUES ('$codPescado','$novo_nome',NOW())";

            if($queryFoto = mysqli_query($link,$sqlFoto)){
                $tipo = "success";
                $msg = "Peixe cadastrado com sucesso!";                
            } else {
                $tipo = "danger";
                $msg = "Falha ao cadastrar o pescado";                
            }
        }   
    }
?>
            ...
            <div class="row">
                ...
                <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4"><div class="chartjs-size-monitor" style="position: absolute; left: 0px; top: 0px; right: 0px; bottom: 0px; overflow: hidden; pointer-events: none; visibility: hidden; z-index: -1;"><div class="chartjs-size-monitor-expand" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:1000000px;height:1000000px;left:0;top:0"></div></div><div class="chartjs-size-monitor-shrink" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:200%;height:200%;left:0; top:0"></div></div></div>
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
                        <h1 class="h2">Cadastrar pescado</h1>                        
                    </div>
                    <?php 
                        if($msg != false){
                            echo "
                    ...
                    ?>                                                                                                                    
                    <form action="cadastra_pescado.php" method="POST" enctype="multipart/form-data" name="formPescado">
                        <div class="form-group">
                                <label for="nomePescado">Nome do peixe:</label>
                                <input type="text" class="form-control" id="nomePescado" name="nomePescado" placeholder="Nome do peixe" required>
                            </div>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="massaPescado">Peso do peixe:</label>
                                <input type="text" class="form-control" id="massaPescado" name="massaPescado" placeholder="Peso do peixe" required>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="tamPescado">Tamanho do peixe:</label>
                                <input type="text" class="form-control" id="tamPescado" name="tamPescado" placeholder="Tamanho do peixe" required>
                            </div>
                        </div>
                        <div class="form-group">                             
                        ...
                        <button type="submit" class="btn btn-primary">Cadastrar peixe</button>
                    </form>
