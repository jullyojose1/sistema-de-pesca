                        ...
                        <table class="table table-striped table-sm">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    $sqlFoto = "SELECT * FROM arqpescado";
                                    $resultado2 = mysqli_query($link,$sqlFoto);

                                    while($dados = mysqli_fetch_array($resultado) and $dados2 = mysqli_fetch_array($resultado2)):
                                        $img = "img/" . $dados2['arquivo'];                                                                                                                       
                                ?>
                                    <tr>
                                        <td><?php echo $dados['codPescado'] ?></td>
                                        <td><?php echo $dados['nomePescado'] ?></td>
                                        <td><?php echo $dados['massaPescado'] ?></td>
                                        <td><?php echo $dados['tamPescado'] ?></td>
                                        <td>
                                            <?php 
                                                echo "
                                                    <div class='thumbnail'>
                                        ...
                                        <td>
                                            <a href="editar_pescado.php?codPescado=<?php echo $dados['codPescado'] ?>" class=" btn btn-primary"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                        </td>
                                        <td>
